...
////// Lighting:
                ...
                float3 Set_RimLight = lerp( _LightDirection_MaskOn_var, (_LightDirection_MaskOn_var+(lerp( _Ap_RimLightColor.rgb, (_Ap_RimLightColor.rgb*Set_LightColor), _Is_LightColor_Ap_RimLight )*saturate((lerp( (node_839 + ( (node_843 - _RimLight_InsideMask) * (node_2717 - node_839) ) / (node_2717 - _RimLight_InsideMask)), step(_RimLight_InsideMask,node_843), _Ap_RimLight_FeatherOff )-(saturate(node_2982)+_Tweak_LightDirection_MaskLevel))))), _Add_Antipodean_RimLight );
