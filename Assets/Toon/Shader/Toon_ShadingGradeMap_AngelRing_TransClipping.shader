...
////// Lighting:
                ...
                float3 Set_RimLight = lerp( _LightDirection_MaskOn_var, (_LightDirection_MaskOn_var+(lerp( _Ap_RimLightColor.rgb, (_Ap_RimLightColor.rgb*Set_LightColor), _Is_LightColor_Ap_RimLight )*saturate((lerp( (node_6470 + ( (node_6788 - _RimLight_InsideMask) * (node_9686 - node_6470) ) / (node_9686 - _RimLight_InsideMask)), step(_RimLight_InsideMask,node_6788), _Ap_RimLight_FeatherOff )-(saturate(node_6920)+_Tweak_LightDirection_MaskLevel))))), _Add_Antipodean_RimLight );
