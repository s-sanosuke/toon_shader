...
////// Lighting:
                ...
                float3 Set_RimLight = lerp( _LightDirection_MaskOn_var, (_LightDirection_MaskOn_var+(lerp( _Ap_RimLightColor.rgb, (_Ap_RimLightColor.rgb*Set_LightColor), _Is_LightColor_Ap_RimLight )*saturate((lerp( (node_1745 + ( (node_6407 - _RimLight_InsideMask) * (node_7132 - node_1745) ) / (node_7132 - _RimLight_InsideMask)), step(_RimLight_InsideMask,node_6407), _Ap_RimLight_FeatherOff )-(saturate(node_3552)+_Tweak_LightDirection_MaskLevel))))), _Add_Antipodean_RimLight );
                ...
                float3 node_4298 = saturate(lerp( _RimLight_var, lerp( (_RimLight_var*node_3547), (_RimLight_var+node_3547), _Is_BlendAddToMatCap ), _MatCap ));
                float3 node_4956 = (DecodeLightProbe( normalDirection )*_GI_Intensity);
                float3 Set_FinalCompOut = saturate((1.0-(1.0-node_4298)*(1.0-node_4956))); // Final Composition
