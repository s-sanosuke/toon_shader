...
////// Lighting:
                ...
                float3 Set_RimLight = lerp( _LightDirection_MaskOn_var, (_LightDirection_MaskOn_var+(lerp( _Ap_RimLightColor.rgb, (_Ap_RimLightColor.rgb*Set_LightColor), _Is_LightColor_Ap_RimLight )*saturate((lerp( (node_9273 + ( (node_3377 - _RimLight_InsideMask) * (node_8606 - node_9273) ) / (node_8606 - _RimLight_InsideMask)), step(_RimLight_InsideMask,node_3377), _Ap_RimLight_FeatherOff )-(saturate(node_175)+_Tweak_LightDirection_MaskLevel))))), _Add_Antipodean_RimLight );
                ...
                float3 node_7817 = saturate(lerp( _RimLight_var, lerp( (_RimLight_var*node_4172), (_RimLight_var+node_4172), _Is_BlendAddToMatCap ), _MatCap ));
                float3 node_8660 = (DecodeLightProbe( normalDirection )*_GI_Intensity);
                float3 finalColor = saturate((1.0-(1.0-node_7817)*(1.0-node_8660)));
