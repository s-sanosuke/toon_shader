...
////// Lighting:
                ...
                float3 Set_RimLight = lerp( _LightDirection_MaskOn_var, (_LightDirection_MaskOn_var+(lerp( _Ap_RimLightColor.rgb, (_Ap_RimLightColor.rgb*Set_LightColor), _Is_LightColor_Ap_RimLight )*saturate((lerp( (node_8830 + ( (node_8285 - _RimLight_InsideMask) * (node_5267 - node_8830) ) / (node_5267 - _RimLight_InsideMask)), step(_RimLight_InsideMask,node_8285), _Ap_RimLight_FeatherOff )-(saturate(node_2654)+_Tweak_LightDirection_MaskLevel))))), _Add_Antipodean_RimLight );
